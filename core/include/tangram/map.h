...
public:
    ...
    // Set the maximum zoom level for the view; values greater than 25 will be
    // clamped to 25; values less than the current minimum zoom level will set
...
enum DebugFlags {
    ...
    //tile_infos,       // Debug tile infos ... now combined w/ tile_bounds
